...
public class ManageTotaleCampo {
    ...
    public void setTotaleCarico(ProspettoDTO dto) throws Exception {
        ResultRow caricoTotale= new ResultRow();
    ...
    public void setTotaleScarico(ProspettoDTO dto) throws Exception{
        ResultRow scaricoTotale= new ResultRow();
    ...
    public void setRigheCarico(ProspettoDTO dto, ResultRow riga , String metodo) throws Exception {
    ...
    public void setRigheScarico(ProspettoDTO dto,ResultRow riga,String metodo) throws Exception{
        String metodoGet= "get"+metodo;
        String metodoSet= "set"+metodo;
    ...
    public Double sumCampoTot(ResultRow riga,String metodo) throws Exception {
        Double tot=0d;
        Double valore=0d;
