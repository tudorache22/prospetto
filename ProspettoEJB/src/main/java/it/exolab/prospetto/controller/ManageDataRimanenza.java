...
public class ManageDataRimanenza {
    ...
    public DataRimanenzaRow calcolaDataRimanenza(CriterioRicerca criterio) throws Exception {
        DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
        ProspettoMapper mapper= new ProspettoMapperImplem();

        DataRimanenzaRow dataRimanenza = mapper.calcolaDataRimanenza(criterio);
    ...
    public void controllDataRimanenza(DataRimanenzaRow dataRimanenza, String name) throws Exception {
